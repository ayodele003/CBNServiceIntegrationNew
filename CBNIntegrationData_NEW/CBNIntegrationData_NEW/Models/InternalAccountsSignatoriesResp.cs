...
// Type: CBNIntegration.Models.InternalAccountsSignatoriesResp
...
{
  public class InternalAccountsSignatoriesResp
  {
    public string Status { get; set; }

    public string Msg { get; set; }

    public InternalAccountsSignatories[] Result { get; set; }
  }
}
